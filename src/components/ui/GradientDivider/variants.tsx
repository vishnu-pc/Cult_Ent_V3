...
const createGradientVariant = (
  ...
  return React.forwardRef<
    ...
    Omit<
      ...
      'animated' | 'cssVariable' | 'preset' | 'leftColor' | 'rightColor'
    >
  >((props, ref) => {
...
export const LandingBannerDivider = createGradientVariant(
  'LANDING_BANNER',
  true
);
...
export const WellnessSolutionsDivider = createGradientVariant(
  'WELLNESS_SOLUTIONS',
  true
);
...
export const LandingBannerDividerStatic = createGradientVariant(
  'LANDING_BANNER',
  false
);
LandingBannerDividerStatic.displayName = 'LandingBannerDividerStatic';

export const LogoLoaderDividerStatic = createGradientVariant(
  'BRAND_PRIMARY',
  false
);
LogoLoaderDividerStatic.displayName = 'LogoLoaderDividerStatic';

export const WellnessSolutionsDividerStatic = createGradientVariant(
  'WELLNESS_SOLUTIONS',
  false
);
WellnessSolutionsDividerStatic.displayName = 'WellnessSolutionsDividerStatic';

export const ClienteleDividerStatic = createGradientVariant(
  'BRAND_PRIMARY',
  false
);
ClienteleDividerStatic.displayName = 'ClienteleDividerStatic';

export const TestimonialsDividerStatic = createGradientVariant(
  'TESTIMONIALS',
  false
);
TestimonialsDividerStatic.displayName = 'TestimonialsDividerStatic';

export const OurImpactDividerStatic = createGradientVariant(
  'OUR_IMPACT',
  false
);
OurImpactDividerStatic.displayName = 'OurImpactDividerStatic';

export const BeBetterSectionDividerStatic = createGradientVariant(
  'NEUTRAL',
  false
);
...
export const createCustomGradientVariant = (
  ...
  return React.forwardRef<
    ...
    Omit<
      GradientDividerProps,
      'animated' | 'cssVariable' | 'leftColor' | 'rightColor'
    >
  >((props, ref) => {
    if (animated) {
      return (
