...
const DynamicLogo: React.FC<DynamicLogoProps> = ({ className }) => {
  ...
  const circumference = 2 * Math.PI * 150; // Radius of 150
  ...
  return (
    ...
    >
      ...
      >
        ...
        <defs>
          <linearGradient id={ringGradientId.current} x1="0%" y1="100%" x2="0%" y2="0%">
            <stop offset="0%" stopColor="#ffffff" />
            <stop offset={`${progressValue}%`} stopColor="#7ED957" />
            <stop offset={`${progressValue}%`} stopColor="#ffffff" stopOpacity="0.3" />
        ...
        <path 
          ...
          fill={isHighlighted ? "#FF3366" : "none"} 
          stroke="white"
          strokeWidth="1"
        />
        ...
        <path 
          ...
          fill={isHighlighted ? "#3CBBEC" : "none"} 
          stroke="white"
          strokeWidth="1"
        />
        ...
        <path 
          ...
          fill={isHighlighted ? "#FFD600" : "none"} 
          stroke="white"
          strokeWidth="1"
        />
        ...
        {/* Semicircular ring - animated */}
        <path
          d="M 190,215 m -180,0 a 180,180 0 1,1 360,0"
          fill="none"
