...
const DynamicLogo: React.FC<DynamicLogoProps> = ({
  ...
  const ringGradientId = useRef(
    `ring-gradient-${Math.random().toString(36).substring(2, 9)}`
  );
  const dotGradientId = useRef(
    `dot-gradient-${Math.random().toString(36).substring(2, 9)}`
  );
  const fillGradientId = useRef(
    `fill-gradient-${Math.random().toString(36).substring(2, 9)}`
  );
  ...
  return (
    <SVGContainer
      ...
      ref={logoRef}
      onMouseEnter={() =>
        forceHighlight === undefined && setIsHighlighted(true)
      }
      onMouseLeave={() =>
        forceHighlight === undefined && setIsHighlighted(false)
      }
    >
      <LogoSVG viewBox='0 0 381 431' xmlns='http://www.w3.org/2000/svg'>
        {/* Definitions for gradients */}
        <defs>
          <linearGradient
            id={ringGradientId.current}
            x1='0%'
            y1='0%'
            x2='100%'
            y2='100%'
        ...
        <g
          transform={`translate(190, 215) scale(${innerScale}) translate(-190, -215)`}
        >
          ...
          <path
            ...
            stroke={isHighlighted ? '#FF3278' : 'white'}
            strokeWidth='1'
          />
          ...
          <path
            ...
            stroke={isHighlighted ? '#40B9EB' : 'white'}
            strokeWidth='1'
          />
          ...
          <path
            ...
            stroke={isHighlighted ? '#FDD914' : 'white'}
            strokeWidth='1'
          />
