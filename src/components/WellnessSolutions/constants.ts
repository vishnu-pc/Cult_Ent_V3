...
export const solutions: Solution[] = [
  {
    ...
    description: 'Unlock 600+ elite fitness centers, gyms and sports facilities nationwide for your team. From HIIT warriors to zen-seeking yogis, everyone finds their fitness home.',
    imageUrl: Wellness1,
  ...
  },
  {
    ...
    description: 'Transform "Maybe I\'ll exercise someday" into "Is it time for our team challenge yet?" with events that spark genuine excitement',
    imageUrl: Wellness2,
  ...
  },
  {
    ...
    description: 'Forget the branded pens. Give something that powers performance and silently reminds them they work for a company that gets it.',
    imageUrl: Wellness5,
